...
// %bb.0:
	...
	.ascii	"->TSK_ACTIVE_MM 1616 offsetof(struct task_struct, active_mm)"
	//NO_APP
	//APP
	...
	.ascii	"->TSK_TI_SCS 88 offsetof(struct task_struct, thread_info.shadow_call_stack)"
	//NO_APP
	//APP

	.ascii	"->TSK_STACK 104 offsetof(struct task_struct, stack)"
	//NO_APP
	//APP
	...
	.ascii	"->THREAD_CPU_CONTEXT 3056 offsetof(struct task_struct, thread.cpu_context)"
	//NO_APP
	//APP
