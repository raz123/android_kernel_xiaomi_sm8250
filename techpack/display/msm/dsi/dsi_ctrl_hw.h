...
struct dsi_ctrl_hw_ops {
	...
	/**
	 * init_cmddma_trig_ctrl() - Initialize command mode DMA trigger control
	 * @ctrl:         Pointer to the controller host hardware.
	 * @cfg:          Common configuration parameters.
	 */
	...
	/**
	 * map_mdp_regs() - Map MDP registers for DSI controller
	 * @pdev:         Pointer to platform device.
	 * @ctrl:         Pointer to the controller host hardware.
	 */
	void (*map_mdp_regs)(struct platform_device *pdev,
			     struct dsi_ctrl_hw *ctrl);

	/**
	 * log_line_count() - Read the current MDP line count
	 * @ctrl:         Pointer to the controller host hardware.
	 * @mode:         Operation mode.
	 *
	 * Return: Current line count.
	 */
	u32 (*log_line_count)(struct dsi_ctrl_hw *ctrl, u32 mode);

	/**
	 * vid_engine_busy() - Check if video engine is busy
	 * @ctrl:         Pointer to the controller host hardware.
	 *
