...
/* MGLRU compat: 4.19 backport uses software path only — hardware PTE young
 * may trigger unstable page table walks on 4.19's mm_walk infrastructure.
 * arm64 has PTE_AF but backport walk_mm integration is untested.
 */
#ifndef arch_has_hw_pte_young
#define arch_has_hw_pte_young()		(false)
#endif
#ifndef CONFIG_ARCH_HAS_NONLEAF_PMD_YOUNG
#define CONFIG_ARCH_HAS_NONLEAF_PMD_YOUNG 0
#endif
			    ...
			    bool reclaimed)
{
	...
	if (PageSwapCache(page)) {
		...
		(void)shadow; /* MGLRU eviction tracking, shadow not in 4.19 swap API */
